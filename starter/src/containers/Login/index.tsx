            ...
            <section className={styles.section}>
                <div className={styles.formWrapper}>
                    ...
                    <div className="flex mt-3">
                        ...
                        <a href="#" className="text-heading-5 text-blue-100 font-semibold ml-2 hover:underline">Daftar di sini</a>
                    </div>
                    ...
                    >
                        ...
                        <a href="#" className="text-heading-5 text-blue-100 font-semibold mt-8 mb-4 hover:underline">Lupa kata sandi?</a>
                        <Button type="submit" fullWidth>Masuk</Button>
                    </form>
                    
                    <p className="text-heading-5 text-gray-70 my-8">Atau masuk dengan</p>
                    <Button variant="google" className="mb-4">Masuk dengan Google</Button>
